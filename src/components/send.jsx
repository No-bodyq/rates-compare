...
const supportedCurrencies = Object.keys(currencyMap);
  ...
  useEffect(() => {
    if (useMockData) {
      const mockRates = [
        {
          provider: "Sendwave",
          exchangeRate: 127.20769,
          amountReceived: 127207.69,
          fees: 0,
          status: "success",
          rateTime: new Date().toLocaleTimeString(),
          sourceType: "API",
          timestamp: "2025-07-14T01:56:00.237Z",
          uniqueId: "Sendwave-0-2025-07-14T01:56:00.237Z",
        },
        {
          provider: "Nala",
          exchangeRate: 127.20769,
          ...
          sourceType: "API",
          timestamp: "2025-07-14T01:56:00.237Z",
          uniqueId: "Nala-1-2025-07-14T01:56:00.237Z",
        },
        {
          provider: "Remitly",
          exchangeRate: 127.20769,
          ...
          sourceType: "API",
          timestamp: "2025-07-14T01:56:00.237Z",
          uniqueId: "Remitly-2-2025-07-14T01:56:00.237Z",
        },
      ];
      console.log("🧪 Using mock data:", mockRates);
      setAllRates(mockRates);
      setBestRate(mockRates[0]);
      setRateComparison({
        best: mockRates[0],
        worst: mockRates[1],
        savings: 0,
    ...
    async (base, target, amount) => {
      ...
      try {
        ...
        if (data.success && data.data.rates.length > 0) {
          ...
          console.warn("❌ No valid exchange rate available:", data.error);
          setRate(null);
        ...
        <div className="flex bg-gray-100 rounded-lg p-1 mb-4">
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
              activeView === "send" ? "bg-white text-blue-600 shadow-sm" : "text-gray-600 hover:text-gray-800"
            }`}
          >
            Rate Calculator
          </button>
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
              activeView === "rates" ? "bg-white text-blue-600 shadow-sm" : "text-gray-600 hover:text-gray-800"
            }`}
          >
            Compare Rates
          </button>
          ...
          <div className="flex-1 relative">
            ...
            {showSourceList && (
              <div className="absolute left-0 mt-1 w-64 border rounded-md bg-white shadow-lg z-30 max-h-48 overflow-y-auto">
                {map(supportedCurrencies, (currency) => (
                  <div
                    key={currency}
            ...
            allRates.map((rateData, index) => {
              ...
              return (
                <div
                  ...
                  className={`flex justify-between items-center p-4 rounded-lg transition-colors min-h-[60px] ${
                    rateData.provider === bestRate?.provider ? "bg-green-50 border-2 border-green-200" : "bg-gray-50 hover:bg-gray-100"
                  }`}
      ...
      <div className="w-full h-2/3 flex flex-col gap-5 p-10 rounded-xl bg-white">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center justify-between rounded-md bg-white h-full min-w-[120px] px-3 ${
                isLoadingRate || rateRequestInProgress.current ? "opacity-50 cursor-not-allowed" : "cursor-pointer hover:bg-gray-50"
              }`}
              disabled={isLoadingRate || rateRequestInProgress.current}
              type="button"
            >
        ...
        <div className="flex justify-center my-2">
          <button
            ...
            disabled={isLoadingRate || rateRequestInProgress.current || !sourceCurrency || !targetCurrency}
            title="Swap currencies"
          >
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className={`w-full ${
              isContinueDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
      ...
      <div className="w-full lg:w-3/5 h-full flex flex-col gap-10">
        <div className="flex items-center justify-between">
          <div className="w-full flex justify-center items-center">
            <h1 className="text-blue-600 text-2xl font-bold">Currency Exchange</h1>
          </div>
        </div>

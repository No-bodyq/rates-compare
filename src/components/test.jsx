                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex bg-gray-100 rounded-lg p-1">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === "benchmark"
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === "comparison"
                                            ? "bg-white text-gray-900 shadow-sm"
                                            : "text-gray-600 hover:text-gray-900"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${activeTab === "simulator"
                                            ? "bg-white text-gray-900 shadow-sm"
                                            : "text-gray-600 hover:text-gray-900"
                                        }`}
                                >
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6 shadow-sm">
                        ...
                        {getProvidersForCorridor(fetchedRates, fromCurrency, toCurrency).length === 0 && (
                            <div className="text-center py-4 text-gray-500">
                                No rates available for {fromCurrency} → {toCurrency} corridor selected click scrape to fetch from different provider's
                            </div>
                        )}
                    </div>
                )}
                                    ...
                                    {benchmarkList.map((item, index) => {
                                        ...
                                        return (
                                            <tr
                                                ...
                                                className={`${isActive ? "bg-blue-50 ring-2 ring-blue-200" : "hover:bg-gray-50"
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 whitespace-nowrap">
                                                    <span
                                                        className={`inline-flex px-2 py-1 text-xs font-medium rounded ${item.type === "provider"
                                                                ? "bg-blue-100 text-blue-800"
                                                                : "bg-purple-100 text-purple-800"
                                                            }`}
                                                    >
                                                        {item.type === "provider" ? "Competitor" : "PCX"}
                                                    </span>
                                                </td>
                                                ...
                                                <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                                    ...
                                                    {isActive && spreadAdjustment !== 0 && (
                                                        <span
                                                            className={`ml-1 text-xs ${spreadAdjustment > 0 ? "text-green-600" : "text-red-600"
                                                                }`}
                                                        >
                                                            {spreadAdjustment > 0 ? "+" : ""}
                                        ...
                                        {[(fromCurrency === "NGN" && toCurrency === "GBP") ? -0.00005 : -1.0, (fromCurrency === "NGN" && toCurrency === "GBP") ? -0.00002 : -0.5, 0.0, (fromCurrency === "NGN" && toCurrency === "GBP") ? 0.00002 : 0.5, (fromCurrency === "NGN" && toCurrency === "GBP") ? 0.00005 : 1.0].map((spread) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <span
                                                            className={`px-2 py-1 text-xs font-medium rounded-full ${position <= 3
                                                                    ? "bg-green-100 text-green-800"
                                                                    : position <= 6
                                                                        ? "bg-yellow-100 text-yellow-800"
